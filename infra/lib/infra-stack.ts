  ...
  constructor(scope: Construct, id: string, props: ImmivoStackProps) {
        ...
        commandHooks: {
          ...
          afterBundling(inputDir: string, outputDir: string): string[] {
            ...
            return [
              ...
              `cd ${outputDir}`,
              `npm init -y`,
              `npm install @prisma/client@5.10.2 prisma@5.10.2 ews-javascript-api sharp --platform=linux --arch=x64`,
              `npx prisma generate`,
    ...
    const frontendLambda = new lambda.DockerImageFunction(this, 'FrontendLambda', {
      ...
      environment: {
        ...
        // NOTE: RUNTIME_STREAM_URL removed — serverless-http is incompatible with RESPONSE_STREAM mode.
        // Chat streaming works via API Gateway (buffered but functional).
