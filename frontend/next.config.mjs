        ...
        headers: [
          ...
          ...(!isDev ? [{ key: 'Strict-Transport-Security', value: 'max-age=63072000; includeSubDomains; preload' }] : []),
          {
            ...
            value: [
              ...
              "media-src 'self' blob: https://*.immivo.ai",
              `connect-src 'self' https://*.immivo.ai wss://*.immivo.ai https://*.amazonaws.com wss://*.amazonaws.com https://*.on.aws wss://meet.immivo.ai https://cognito-idp.eu-central-1.amazonaws.com${devConnectSrc}`,
              "frame-src 'self'",
              "base-uri 'self'",
              "form-action 'self'",
