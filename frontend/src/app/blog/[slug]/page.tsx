          ...
          {loading ? (
            ...
            <>
              ...
              <article>
                ...
                <div
                  className="prose prose-lg prose-gray max-w-none prose-headings:font-bold prose-a:text-blue-600 prose-a:no-underline hover:prose-a:underline prose-img:rounded-lg prose-blockquote:border-l-blue-600 prose-blockquote:bg-gray-50 prose-blockquote:py-1 prose-blockquote:px-4"
